...
export default function LifestyleSection() {
  ...
  const bullets = toList<Bullet>(t("lifestyle.bullets", { returnObjects: true }));

  return (
    <AnimatedSection id="lifestyle" className="section-shell pt-6">
      <section className="rounded-3xl bg-white p-5 shadow-sm">
        <h2 className="headline-balance max-w-[14ch] text-3xl font-extrabold leading-[1.18] tracking-tight text-[#111813]">{t("lifestyle.title")}</h2>
