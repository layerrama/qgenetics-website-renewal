  ...
  return (
    <header className="sticky top-0 z-50 border-b border-[#e3ebe5] bg-[#f6f8f6]/90 px-4 py-3 backdrop-blur-md">
      <div className="flex items-center justify-between">
        <button className="flex h-10 w-10 items-center justify-center rounded-full text-xl text-[#111813] hover:bg-[#e9efe9]" aria-label={t("common.menu")}>
          ☰
        </button>
        <Logo className="flex items-center gap-2" />
        <LanguageToggle />
      </div>
      <nav className="hide-scrollbar mt-3 overflow-x-auto">
